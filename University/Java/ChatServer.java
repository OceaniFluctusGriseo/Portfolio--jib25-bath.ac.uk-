...
public class ChatServer {
    ...
    public ChatServer(String[] args){
        ...
        //catch an IO exception caused by initiating the server
            ...
            e.printStackTrace();
            System.out.println("An error occurred while trying to set up a server socket");
        }
    }
    ...
    private void run(){
        ...
        System.out.println("Welcome server admin! ServerSocket localPort: " + chatServerSocket.getLocalPort() +"\n Enter 'EXIT' to close server");
        try {
            ...
            System.out.println("An error occurred while reading admin input");
        }
        //close down the server and clients upon closure
            ...
            for(Socket clientSocket : clients){
                try{clientSocket.close();}catch(IOException e){System.out.println("An error occurred while trying to close a client connection");}
            }
        }
    }
    ...
    private class ClientThread extends Thread{
        ...
        public void run(){
            try{
                ...
                System.out.println("Client closing on port: " + clientSocket.getPort());
        ...
        public void run(){
            while(true){
                ...
                try {
                    ...
                    System.out.println("Connecting client on port: " + clientSocket.getPort());
                ...
                //catch any IO exceptions that may happen during waiting for a client
                    ...
                    System.out.println("An IO error occurred while trying to connect a client: " + e);
                }
            }
        }
    }
